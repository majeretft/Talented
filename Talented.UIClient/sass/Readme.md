...
folder are mapped to the application's root namespace, 'Talented.UIClient'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "Talented.UIClient"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'Talented.UIClient' in the same way
as `"Talented.UIClient/sass/src"`.
